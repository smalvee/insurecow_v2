    ...
    <div class="container-xl px-4 mt-4">
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header">Claim Insurance -<span {{-- style="color: red">&nbsp;Under Construction</span></div> --}} <div class="card-body">
                            ...
                            <form action="{{ route('claim.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <label class="small mb-1" for="inputOrgName">Muzzle Of Cow [Insert the image of the cow muzzle]</label>
                                    ...
                                    <input type="hidden" class="form-control" name="muzzle_token" value="sample">
